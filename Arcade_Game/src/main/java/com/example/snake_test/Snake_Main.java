...
public class Snake_Main extends GameApplication implements Snake_Main_overide {

    private final Snake_Factory snake_factory = new Snake_Factory();
    ...
    protected void initGame() {
        getGameWorld().addEntityFactory(new Snake_Factory());
